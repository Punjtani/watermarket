          ...
          <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar  flex-column"
             data-widget="treeview" role="menu" data-accordion="false" style="margin-top:55px">
              ...
              <li class="nav-item">
                <a href="/users/<?php echo e($v[0]->distributor_id); ?>" class="nav-link">
              ...
              <li class="nav-item">
                <a href="/waterlap/<?php echo e($v[0]->distributor_id); ?>" class="nav-link">
                       ...
                       <?php $__currentLoopData = $v; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                           ...
                           <a href="#" class="nav-link">
                            <button type="button" class="btn btn-default btn-lg" style="border-radius:40px;">
                                <img class ="img-fluid" src="https://www.mywatermarket.com:3001/<?php echo e($p->url); ?>">
                            </button>
